...
This guide provides best practices for using Kastor Gen effectively in your projects.
...
class OntoMapperMetrics {
    private val materializationCounter = Counter.build()
        .name("kastor_gen_materializations_total")
...
Following these best practices will help you build robust, maintainable applications with Kastor Gen. Remember to:
