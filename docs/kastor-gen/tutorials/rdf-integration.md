...
This tutorial covers advanced RDF integration using Kastor Gen's side-channel architecture to access RDF-specific functionality when needed.
...
rdfHandle.graph.add {
    ...
    node - SKOS.note - "Created via Kastor Gen"
}
