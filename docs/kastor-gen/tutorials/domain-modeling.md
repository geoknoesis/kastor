# Domain Modeling with Kastor Gen

This tutorial covers best practices for creating domain interfaces that work well with Kastor Gen's side-channel architecture.
