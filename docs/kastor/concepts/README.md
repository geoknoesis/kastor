...
If you are **changing the codebase**, start with [Repository architecture](architecture.md) for Gradle modules and dependency direction, then [Physical repository layout](architecture.md#physical-repository-layout) for where modules live on disk. For **roadmap, implementation status, and quality gates**, see [**Project**](../project/index.md).
