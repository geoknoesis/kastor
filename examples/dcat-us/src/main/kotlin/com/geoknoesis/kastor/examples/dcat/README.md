...
kastorGen {
    ontology {
        ...
        format = "turtle"
        packageName = "com.geoknoesis.kastor.examples.dcat"
        ...
        // Custom mappings for better Kotlin naming
        propertyMappings {
            "http://www.w3.org/ns/dcat#title" to "title"
            "http://www.w3.org/ns/dcat#description" to "description"
            "http://www.w3.org/ns/dcat#keyword" to "keywords"
            // ... more mappings
        }
