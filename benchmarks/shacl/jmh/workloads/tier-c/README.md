...
- **Ontology quality** — e.g. `tools/onto-quality/library` bundled shapes + `oops-corpus` (often validated as one catalog run rather than a single data/shapes file pair).
