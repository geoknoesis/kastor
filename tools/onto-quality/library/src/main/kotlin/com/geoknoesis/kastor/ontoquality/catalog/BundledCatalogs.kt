...
object BundledCatalogs {
     ...
     */
    val OOPS_PITFALL_REGISTRY: ShapeCatalog =
        ResourceCatalog(
            id = "oops-pitfall-registry",
            name = "OOPS! pitfall registry (P01–P41 + Kastor K01–K07)",
            version = "0.1.0",
            resourcePath = "/shapes/oops-pitfall-registry-shacl.ttl",
        )
    ...
    /** Active validation bundles plus machine-readable OOPS! definitions (no extra violations). Same composition as [QualityChecker]'s [QualityChecker.Builder.withAllBundledCatalogs]. */
    val allWithOopsRegistry: List<ShapeCatalog> = all + OOPS_PITFALL_REGISTRY
