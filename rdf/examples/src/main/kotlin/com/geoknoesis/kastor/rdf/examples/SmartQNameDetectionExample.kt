...
fun main() {
    ...
    repo.add {
        ...
        person - "foaf:homepage" - "http://example.org/profile"
        person - "schema:url" - "https://example.org/website"
        ...
        person - "foaf:note" - "unknown:Person"
        person - "foaf:comment" - "dc:creator"
        ...
        person has "schema:worksFor" with "http://example.org/company"  // Full IRI → IRI
    ...
    repo.add {
        ...
        person2 - "foaf:knows" - qname("foaf:Person")    // → <http://xmlns.com/foaf/0.1/Person>
        
        // Explicit string literal
        person2 - "foaf:name" - literal("foaf:Person")   // → "foaf:Person"^^xsd:string
        
        // Explicit IRI
        person2 - "foaf:homepage" - iri("http://example.org")  // → <http://example.org>
        
        // Language-tagged literals
        person2 - "foaf:name" - lang("Alice", "en")      // → "Alice"@en
        
        // Typed literals
        person2 - "foaf:age" - Literal("30", XSD.integer)  // → "30"^^xsd:integer
